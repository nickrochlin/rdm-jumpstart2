...
```{r}
data <- data |> mutate(province_char = recode_factor(data$province, 
                            "10" = "NL", 
                            "11" = "PEI", 
                            "12" = "NS",
                            "13" = "NB", 
...
```{r class.source = 'fold-hide', results = 'hide'}
data<-data |> mutate(maritalStat_char = recode_factor(data$maritalStat, 
                            "1" = "Married", 
                            "2" = "Living common-law", 
                            "3" = "Widowed",
                            "4" = "Separated", 
...
```{r class.source = 'fold-hide', results = 'hide'}
data <- data |> mutate(eduLevel_char = recode_factor(data$eduLevel,
