...
:::note
  Subsetting data is an essential part of the *data exploration* stage in the data science workflow. It involves extracting a portion of the dataset based on specific conditions.
:::
