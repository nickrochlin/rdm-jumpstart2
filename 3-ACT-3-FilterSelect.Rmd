...
### Before moving on to the exercise: recode variable values and save the current dataset
...
```{r, echo=FALSE}
kable(js_data |> distinct(popCenter)) |> kable_styling()
kable(js_data |> count(extraTime) |> arrange(desc(n)) |> head(10)) |> kable_styling()
```
