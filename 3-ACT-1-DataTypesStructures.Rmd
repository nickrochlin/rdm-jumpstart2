...
First we load our data and the dplyr package (remember to install it first if you haven't yet). Information on the data type can be seen in the "head" function in R. 
```{r, message = FALSE}
library(dplyr)
