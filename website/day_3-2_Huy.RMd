...
The expression `data$feelRushed == "daily"` creates a logical vector that is `TRUE` for rows where the value equals `"daily"`. Using square brackets `([ , ])`, we subset data to keep only rows where that condition is `TRUE`
