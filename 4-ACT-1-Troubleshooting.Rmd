...
## Common Errors in R
 - Not closing parenthesis, curly brace, square bracket or quotation mark
 - Typos or mistakes in names of dataset, variables, functions
 - Calling a function of a library we forgot to install or load
 
 #note:will add examples of each
...
#note: working on the code for the team challege, I expect to have it done this weekend
