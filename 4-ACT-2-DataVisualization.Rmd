...
``` {r, echo = FALSE}
ggplot(js_data, aes(x=maritalStat_char, fill = as.factor(maritalStat_char))) +
  geom_bar() + 
  xlab("Marital Status") +
  ylab ("Number of Participants") +
  scale_fill_hue(c = 60) +
...
The go-to package for data visualization in R is `ggplot2`, which is part of the tidyverse. You can find more information about `ggplot2` on the <a href="https://ggplot2.tidyverse.org/">ltidyverse website</a>.
...
ggplot(js_data, aes(x = as.factor(isFeelRushed), y = durWork)) +
  ...
  xlab("Feeling Rushed") +
  ylab ("Time Working") +
  labs(title = "Association Between Working and Feeling Rushed") +
