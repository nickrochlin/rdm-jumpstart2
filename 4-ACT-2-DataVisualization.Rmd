...
#### Making a Bar Plot
Building from yesterday, let's see if people who feel rushed tend to work more than people who do not feel rushed. 

```{r}
ggplot(data, aes(x = isFeelRushed, y = durWork)) +
  geom_bar(stat = "summary") + 
  xlab("Feeling Rushed") +
  ylab ("Time Working") 
```

IMPROVE AND ADD WALKTHROUGH
